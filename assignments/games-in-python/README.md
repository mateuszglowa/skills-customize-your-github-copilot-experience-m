...
- Display the current word progress using placeholders such as `_ _ _`.

### 🛠️ Build Gameplay Flow

#### Description
Implement the interactive gameplay loop so the player can guess letters and receive game results.
